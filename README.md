# خرید هوشمند چند دسته‌ای (Smart Checklist PWA)

یک Progressive Web App برای مدیریت خرید‌های چند دسته‌ای (سفر، کار، خانه، سلامت و ...) ساخته‌شده با Vue 3، Vite و Pinia. تمام داده‌ها به‌صورت آفلاین در `localStorage` مرورگر نگهداری می‌شوند و هیچ بک‌اندی لازم نیست.
...
├── data/
│   └── defaultChecklists.js      # ۱۷ خرید پیش‌فرض کامل
└── router/
```
...
- ریست کامل یک خرید و ساخت خرید شخصی از صفر
